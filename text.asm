...
_FanClubPicture1Text::
	text "סיחום המתוק שלי."
	done

_FanClubPicture2Text::
	text "פחדרור האהוב שלי."
	done
...
_Colosseum3MonsText::
	text "דרושים 3 #ימונים"
	line "כדי להילחם!"
	prompt

_ColosseumMewText::
	text "מצטערים, לתש אסור"
	line "להשתתף!"
	prompt
...
_ColosseumMaxL55Text::
	text "ל#ימונים מעל רמה"
	line "55 אסור להשתתף!"
	prompt

_ColosseumMinL50Text::
	text "כל ה#ימונים"
	line "צריכים להיות ברמה"
	cont "05!"
	prompt
