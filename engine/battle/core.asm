...
; put cursor in right column for normal battle menu (i.e. when it's not a Safari battle)
	Coorda 4, 14 ; clear upper cursor position in right column
	Coorda 4, 16 ; clear lower cursor position in right column
...
.upperRightMenuItemWasNotSelected ; a menu item other than the upper right item was selected
	cp $2
